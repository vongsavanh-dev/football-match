...
<!--        </template>-->
    ...
    <ModalAdd>
      <template v-slot="{ close }">
        <AddAmountStandingTeam @close="close" @success="FetchData()" />
      </template>
    </ModalAdd>
<!--    <ModalEdit>-->
<!--      <template v-slot="{ close }">-->
<!--        <EditTournament @close="close"  @success="FetchData()" />-->
<!--      </template>-->
<!--    </ModalEdit>-->

<!--    <ModalDelete>-->
<!--      <template v-slot="{ close }">-->
<!--        <DeleteTournament @close="close" " @success="FetchData()" />-->
<!--      </template>-->
<!--    </ModalDelete>-->
  </div>
</template>
...
import  AddAmountStandingTeam from './CRUD/AddAmountTeamStanding'
export default {
  components: {
    AddAmountStandingTeam,
  },
  data: () => ({
    page: 1,
    max: 5,
